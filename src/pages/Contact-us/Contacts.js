...
const Contacts = () => {
  const [enteredValues,setEnteredValues] = useState({name:'',phone:'',email:'',message:''})
          ...
          <div  className="my-5 p-4">
            ...
            <Col className="col-md-6 ">
              <p className="careers__desc pt-4 mb-5">
                ...
                technology prowess, delivery focus and quality of work to help
                our clients ideate and develop their dream products
              </p>
